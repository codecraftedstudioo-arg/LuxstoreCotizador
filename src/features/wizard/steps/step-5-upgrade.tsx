...
export function Step5Upgrade() {
  ...
  return (
    <Card>
      ...
      {/* Initial choice — two cards + market preview */}
      {!wantsUpgrade && (
        <div className="space-y-3">
          <button
            type="button"
            onClick={handleWantsUpgrade}
            className="w-full p-4 h-20 rounded-xl border-2 border-white/10 bg-white/5 hover:border-blue-500/50 hover:bg-blue-500/5 transition-all text-left group"
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-white/40 mt-0.5">
                  {lang === 'es' ? 'Elegí tu nuevo iPhone y calculamos la diferencia' : 'Pick your new iPhone and we\'ll calculate the difference'}
                </p>
              </div>
            </div>
          </button>
