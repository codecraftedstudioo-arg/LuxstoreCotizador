      ...
      >
        <div className="max-w-6xl mx-auto px-4 mb-6">
          <div className="flex items-center justify-center gap-3">
            ...
            <span className="text-fg-muted text-sm">4.9 en Google Reviews</span>
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-2.5">
            ...
            <FAQItem question="¿Dónde están ubicados?">
              <p className="text-fg-muted text-[13px] sm:text-sm leading-relaxed">
                Estamos en <strong className="text-fg">Costa Rica 5509, Palermo, CABA</strong>. Podés venir sin turno de lunes a sábados.
              </p>
            </FAQItem>
      ...
      <footer className="relative z-10 border-t border-line py-8 bg-bg">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-fg-subtle text-sm">© {new Date().getFullYear()} Electronic Point. Todos los derechos reservados.</p>
          ...
          <div className="border-t border-line mt-6 pt-6 text-center">
            <p className="text-xs text-fg-subtle">
              Built by{' '}
              <a href="https://www.linkedin.com/in/nicolas-kevorkian/" target="_blank" rel="noopener noreferrer" className="text-fg-muted hover:text-fg transition-colors">
                Nicolás Kevorkian
              </a>
            </p>
          </div>
